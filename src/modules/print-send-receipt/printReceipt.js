            ...
            <div>
                <div className='post-void-modal-container'>
                    ...
                    <div className='post-void-modal-button-area'>
                        ...
                        <button className='post-void-modal-button-enter'><span className='post-void-modal-button-enter-label' onClick={this.props.openPrintEnterTrans}>ENTER TRANS #</span></button>
                    </div>
                </div>
            </div>
        );
