...
class PostVoidSelect extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if(nextProps.postvoidtransdetails.response.response_text==="IM_SUCCESS")
        {
    ...
    postVoidTransInvoker = () => {
        ...
        this.props.PostVoidTransDetls(this.props.login.userpin,this.state.selectedTransactionDetails,this.state.selectedTransactionDetails.transactionID);
        //this.props.history.push('/postvoiddetails');
        }
        else {
            //DO NOTHING
