...
export class VerifyEmailModal extends Component {
    ...
    render() {
        const errorDiv = this.props.emailFailure
            ? (
        ...
        return (
            <Modal
                open={this.props.emailverifyModal}
                ...
                <div className='add-dom-cust-container'>
                    {errorDiv}
                    <img src={emailmodalicon} className='add-dom-cust-modal-icon'/> {/* <div className="add-dom-cust-email-verify-modal-name">{this.props.fname} &nbsp;{this.props.lname}</div> */}
                    ...
                    <div className="cust-email-tooltip">
                        ...
                        {this.props.email !== undefined
                            ? (this.props.email.length > 25
                                ? <img
                                        className="tooltip-info-icon"
                                        data-tip={this.props.email}
                                        src={info}/>
                                : '')
                            : ''}
                    </div>
