...
export class DriversLicenseModal extends Component {
       ...
       const textFieldUnderlineStyle = {
        ...
        return (
            ...
            onClose={this.props.close}>
                ...
                <img className="drivers-license-icon" src={warning} alt="warning"/>
                ...
                />
                 ...
                 <div className="drivers-license-button-container">
                    ...
                    <div className="drivers-license-button-ok" 
                        onClick={() => this.props.validateDriversLicense(this.state.driversLicense)}>OK</div>
                </div>
            </Modal>
        )
    }
    ...
    getLicenseNumber = (e) => {
        let license = Number(e.target.value);
...
export class CustomerServiceModal extends Component {
    render() {
        return (
            ...
            <div className="cust-service-code">CODE:<span className="cust-service-data">GCKY</span></div>
            ...
            >
                ...
                <div className="confirm-license-button-container">
                    ...
                    <div className="confirm-license-button-yes"
                        onClick={() => {this.props.componentToRender('purchaser')}}>YES</div>
                </div>
